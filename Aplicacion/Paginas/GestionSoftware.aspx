            ...
            <div class="row control-group">
                  ...
                  <div class="row">
                    <div class ="col-lg-6 form-group float-label-control">
                        <label for="">Nombre del Software</label>
                        <input type="text" class="form-control" id="txtNombre" placeholder="Nombre del Software"  required  title="Ingresa el Nombre del Software">
                    </div>
                    <div class ="col-lg-3 form-group float-label-control">
                ...
                <div class="row">
                    <div class="col-lg-6 float-label-control">
                        <label for="">Requerimientos Tecnicos</label>
                   ...
                   <br /> <br />
                    ...
                    <div class="col-lg-3 float-label-control">
                        <label for="">Derechos de Autor</label>
                        <input type="text" class="form-control" id="txtAdjuntar" placeholder="Adjuntar contrato de derechos de autor" />
                    </div>
                    <div class="col-lg-1">
                        <button type="button" class="btn btn-primary btn-sm">
                            <span class=" fa fa-cloud-upload"></span>  Adjuntar
                        </button>
                    </div>
                </div>
                <br>
